  ...
  const processUploadedImage = async (imageDataUrl: string, sourceDims?: UploadSourceDimensions | null) => {
    ...
    try {
      ...
      if (pairedProduct) {
        ...
        if (step1.crop_left_ratio && step1Image.startsWith('http')) {
        ...
        if (step2.success && step2.generated_image) {
          ...
          if (step2.crop_left_ratio && step2Image.startsWith('http')) {
      ...
      if (result.success && result.generated_image) {
        ...
        if (result.crop_left_ratio && finalImage.startsWith('http')) {
